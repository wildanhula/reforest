...
<body class="bg-gray-100">
  ...
  <header class="bg-[#D2E2E2] shadow">
    <div class="container mx-auto flex justify-between items-center p-4">
      ...
      <nav class="flex items-center justify-items-center space-x-6">
        <div class="hidden md:flex items-center space-x-6">
          <a href="#" class="text-gray-700">Home</a>
          <a href="#" class="text-gray-700">Lokasi</>
          <a href="#" class="text-gray-700">Pohonku</a>
          <a href="#" class="text-gray-700">Artikel</a>
          <a href="#" class="text-gray-700">FAQs</a>
          <a href="{{ route('register') }}" class="bg-white text-[#004C6D] py-1 px-4 border border-[#004C6D] hover:bg-[#004C6D] hover:text-white">SignUp</a>
          <a href="{{ route('login') }}" class="bg-[#004C6D] text-white py-1 px-4 border rounded-full hover:border-[#004C6D] hover:bg-white hover:text-[#004C6D]">Login</a>
        </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#D2E2E2] px-4 py-2 space-y-2">
      ...
      <a href="#" class="block text-gray-700 ">Pohonku</a>
      <a href="#" class="block text-gray-700 ">Artikel</a>
